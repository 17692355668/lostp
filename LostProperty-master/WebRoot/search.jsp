...
<div class="find">
		...
		<div class="seek">
			...
			<ul>
				...
				<li><a href="<c:url value='/ThingServlet?method=query&search=钱包'/>">钱包</a></li>
				<li><a href="<c:url value='/ThingServlet?method=query&search=卡片'/>">卡片</a></li>
				<LI><a href="<c:url value='/ThingServlet?method=query&search=其他'/>">其他</a></LI>
